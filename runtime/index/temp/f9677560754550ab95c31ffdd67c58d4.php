...
<div class="mask"></div>
  ...
  <div class="nbanner"
    style="background: url(<?php $categoryData['thumb']=str_replace('\\','/',$categoryData['thumb']);echo $categoryData['thumb']; ?>) no-repeat center center; width: 100%;height: 333px"><!-- 动态调用图片 -->
  </div>
 ...
 <div class="mar_t_30 mar_b_30" id="nright_content">
              ...
              <div class="fenye"> <?php echo $archivesData; ?></div><!-- 分页不够二十条就不显示 -->
