            ...
            <div class="right_content_main">
                <div class="right_content_main_box padding_20">
                        <span class="layui-breadcrumb">
                            ...
                            <div class="mar_t_15">
                                <a class="layui-btn " href="<?php echo url('ad/add'); ?>">+添加</a>
                            ...
                            <div class="mar_t_15">
                                <table class="layui-table ">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                          <a href="<?php echo url('ad/edit',array('id'=>$vo['id'])); ?>" title="修改"><i class="layui-icon layui-icon-edit"></i></a>
                                          <a onClick="public_del('<?php echo url('ad/del', ['id'=>$vo['id']]); ?>')" href="javascript:;"  title="删除"><i class="layui-icon layui-icon-delete"></i></a>
                                        </td>
                                      </tr>
