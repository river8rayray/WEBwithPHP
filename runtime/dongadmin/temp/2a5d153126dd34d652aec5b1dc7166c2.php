              ...
              <div class="layui-tab-item layui-show">
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-block">
                      <input type="text" name="title" class="layui-input"> <!-- name一定要和数据表里的名称一致。 -->
                  </div>
                </div>
