...

{
	...
	public function index(){
        ...
        $categoryTree =$category_model->getTree();//可以用￥category_model访问Categorys类里面的所有方 法了
    ...
    public function edit($id=0) {
        ...
        $categoryData =Db::name('category')->find($id);//一维数组;;;要确保id是主键
    ...
    public function del($id=''){
        ...
        $categorys = Db::name('Category')->field('id')->select();
        $category_model = new Categorys();
